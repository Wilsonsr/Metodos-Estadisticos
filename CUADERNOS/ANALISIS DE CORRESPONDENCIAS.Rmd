...
$$
E_{i j}=n \ldots p_{i j}=n \ldots p_{i} \cdot p_{. j}=\frac{n_{i} \cdot n_{. j}}{n_{. .}}
$$
...
$$
\chi^{2}=\sum_{i=1}^{r} \sum_{j=1}^{c} \frac{\left(n_{i j}-\frac{n_{i} n_{\cdot j}}{n_{. .}}\right)^{2}}{\frac{n_{i} \cdot n_{\cdot j}}{n_{.}}}
$$
